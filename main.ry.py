...
from keboard.key_inline import get_keyboard_inline, get_keyboard_inline_1, get_keyboard_inline_2, get_keyboard_inline_3, get_keyboard_inline_4, get_keyboard_inline_5
...
async def button_2_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://edalove.ru/wp-content/uploads/2022/10/photo.jpg', caption='Вот тебе вкусная окрошка', reply_markup= get_keyboard_inline())

@dp.message_handler(lambda message: message.text == 'Отвравь фото куринова супа')
async def button_2_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://recept-borscha.ru/wp-content/uploads/4/4/6/446b6d7c8eccb8014b515076ebfe1416.jpeg', caption='Вот тебе вкусный куриный суп', reply_markup= get_keyboard_inline_1())

@dp.message_handler(lambda message: message.text == 'Отвравь фото борща')
async def button_2_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663686606_11-mykaleidoscope-ru-p-borshch-so-smetanoi-oboi-15.jpg', caption='Вот тебе вкусный борщ', reply_markup= get_keyboard_inline_2())
...
async def button_4_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://cdn.fishki.net/upload/post/2018/11/11/2763706/zharenaya-kartoshka-s-lukom-i-chesnokom.jpg', caption='Вот тебе вкусная картошка', reply_markup= get_keyboard_inline_3())

@dp.message_handler(lambda message: message.text == 'Отвравь фото карбонара')
async def button_4_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Espaguetis_carbonara.jpg/1280px-Espaguetis_carbonara.jpg', caption='Вот тебе вкусная карбонара', reply_markup= get_keyboard_inline_4())

@dp.message_handler(lambda message: message.text == 'Отвравь фото стейка')
async def button_4_slick(message: types.Message):
    await bot.send_photo(message.chat.id, photo= 'https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663788543_38-mykaleidoscope-ru-p-steik-tibon-yeda-krasivo-42.jpg', caption='Вот тебе вкусный стейк', reply_markup= get_keyboard_inline_5())
